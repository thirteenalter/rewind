<script lang="ts">
  ...
  // Reactive data dari load function (+page.ts)
  ...
  // Sync movies saat data pertama kali masuk
  $: if (initialMovies) {
  ...
  // Ambil item pertama untuk Hero Background
  ...
  {#if featured}
    <section class="relative w-full h-[60vh] overflow-hidden">
      ...
      >
        ...
        >
          <span class="text-white font-bold">{total} Titles</span>
